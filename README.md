...
``` 
python ./src/sft_plain.py --config_path [YOUR_CONFIG_FILE]
```
...
```
python ./src/sft_lora.py --config_path [YOUR_CONFIG_FILE]
```
...
```
python ./src/completion/completion_gen.py --config_path [YOUR_CONFIG_FILE]
```
